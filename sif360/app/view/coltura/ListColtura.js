(function() {
    Ext.define('SIF360.view.coltura.ListColtura' ,{
                                    ...
                                    items : [
                                        {
                                            text    : 'Insert Record',
                                            handler : function(){
                                                var newColtura = Ext.create("SIF360.model.coltura.TableColtura");
                                                newColtura.set('n_piano', SIF360.config.Runtime.getPianoSelectedId());
